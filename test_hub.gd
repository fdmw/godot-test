...
const TEST_SCENES: Array[String] = [
	"res://tests/controls/control_test.tscn",
	"res://tests/tilemap/tilemap_test.tscn",
	"res://tests/particles/particles_test.tscn",
	"res://tests/physics/physics_test.tscn",
	"res://tests/animation/animation_test.tscn",
	"res://tests/camera/camera_test.tscn",
	"res://tests/audio/audio_test.tscn",
	"res://tests/navigation/navigation_test.tscn",
	"res://tests/viewport/viewport_test.tscn",
	"res://tests/input/input_test.tscn",
	"res://tests/rendering/rendering_test.tscn",
	"res://tests/scene_resource/scene_resource_test.tscn",
	"res://tests/tween/tween_test.tscn",
	"res://tests/resource_data/resource_data_test.tscn",
	"res://tests/file_config/file_config_test.tscn",
	"res://tests/scene_lifecycle/scene_lifecycle_test.tscn",
	"res://tests/audio_bus/audio_bus_test.tscn",
	"res://tests/window_display/window_display_test.tscn",
	"res://tests/visibility/visibility_test.tscn",
	"res://tests/physics_extra/physics_extra_test.tscn",
	"res://tests/path_2d/path_2d_test.tscn",
	"res://tests/astar/astar_test.tscn",
	"res://tests/parallax/parallax_test.tscn",
	"res://tests/dialog/dialog_test.tscn",
	"res://tests/drag_drop/drag_drop_test.tscn",
	"res://tests/canvas_transform/canvas_transform_test.tscn",
	"res://tests/resource_loading/resource_loading_test.tscn",
	"res://tests/localization/localization_test.tscn",
	"res://tests/animation_tree/animation_tree_test.tscn",
	"res://tests/pause_process/pause_process_test.tscn",
	"res://tests/groups/groups_test.tscn",
	"res://tests/skeleton_2d/skeleton_2d_test.tscn",
	"res://tests/remote_transform_2d/remote_transform_2d_test.tscn",
	"res://tests/navigation_query/navigation_query_test.tscn",
]
